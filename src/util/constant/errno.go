...
var Errno = map[int]string{
	...
	10051: "invalid wallet address",
	10052: "wallet address is not in the deployment allowlist",
	10053: "requested wallet is disabled or belongs to another network",
}
...
var (
	...
	WalletAddressInvalidErr       = Err(10051)
	WalletAddressNotAllowedErr    = Err(10052)
	WalletSelectionUnavailableErr = Err(10053)
)
